...
def get_sensor_logs(
    ...
    sensor_ids: Optional[List[str]] = Query(None, description="Filter by one or more sensor IDs"),
    sensor_kind: Optional[str] = Query(None, description="Filter by sensor kind"),
