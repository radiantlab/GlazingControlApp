            ...
            <main className="hmi-main docs-layout">
                ...
                <div className="room-section">
                    <div className="room-header">
                        <h1 className="room-title">Routine Builder Documentation</h1>
                    </div>
                ...
                <div className="room-section">
                    <h2 className="room-header">Execution Modes</h2>
                ...
                <div className="room-section">
                    <h2 className="room-header">Logging and Console Output</h2>
                ...
                <div className="room-section">
                    <h2 className="room-header">Saving Routines</h2>
...
for s in sensor_list:
    ...
    log(f"{s['label']} ({s['id']}): lux = {val}")`}
                ...
                <div className="room-section">
                    <h2 className="room-header">Available Sensors & Metrics</h2>
                    <p style={{ lineHeight: "1.6", marginBottom: "16px" }}>
                    ...
                    <details style={{ backgroundColor: "var(--hmi-panel-bg)", padding: "16px", borderRadius: "8px", border: "1px solid var(--hmi-border)", marginBottom: 0, cursor: "pointer" }}>
